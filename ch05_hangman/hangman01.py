import random
# word_list 내부의 element 중 하나를 임의로 선택하기 위새 randam 모듈 도입(추후 수업)
...
print(chosen_word)
# todo - 2 : 사용자에게 알파벳을 하나 추측해서 입력하라고 요청하고, 이를 guess 변수에 담으시오. 그리고 대문자로 시작하는 경우를 방지하기 위해 input() 함수enldp .lower()를 적용하시오.
...
guess = input('알파벳을 하나 추축해서 입력하세요 >>> ').lower()
